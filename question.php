...
<form name="myForm" action="questiondisplay.php" onsubmit="return validateForm();" method="post">

<br><br>
<h2 style="margin-left: 350px;">Title <h2><textarea style="margin-left: 150px;" name="title" rows="2" cols="80" ></textarea>
<br><br>
<h2 style="margin-left: 310px;">Description <h2><textarea style="margin-left: 80px;" name="desc" rows="10" cols="100"></textarea>
<br><br>
