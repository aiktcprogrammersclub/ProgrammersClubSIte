    ...
    <section class="">
      <div class="wrapper">
        <article class="grid_3">
          ...
          <p class="MB0"> Enter your name and password to login. </p>
        </article>
        <article class="grid_9">
          <form action="log.php" method="post" id="lform" name="lform" class="clearfix">
            <ul id="homehireus" class="hireform">
              ...
              <li>
                <input type="Submit"  value="Enter In Club" tabindex="4">
              </li>
            </ul>
          </form>
          <div id="output"></div>
